...
class RetrievalContextManager:
    ...
    def rebuild_all_hash_buckets(self, replay_buffer, world_model, chunk_size=8192):
        ...
        # 1. Collect all valid latents in chunks to prevent GPU OOM
        ...
        if not all_encoded_latents:
            return
            
        full_latents = torch.cat(all_encoded_latents, dim=0) # [Total_valid, latent_dim]
