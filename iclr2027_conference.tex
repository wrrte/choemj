...
\caption{Background-noise application to actual $64\times64$ observations from Frostbite (top) and Seaquest (bottom). Each row uses one fixed observation; the seven columns show $\alpha=0,0.1,0.2,0.4,0.6,0.8,1$, matching the quantitative sweep.}
