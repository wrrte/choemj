...
Accurate prediction by a supervised probe does not guarantee effective use of the same information for control, since supervised probes and Actor-Critic learners receive different learning signals and optimize different objectives. Motivated by the probing evidence and the observed run-to-run variation, we investigate whether targeted reuse of informative experiences can make downstream learning more reliable. FLASH identifies salient learning events, retrieves structurally similar past experiences through hashing, and incorporates them into the same Actor-Critic training batch. Its design targets experiences already encountered rather than discovering previously unseen rewarding behavior.
