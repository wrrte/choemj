...
Crucially, cosine differences indicate representational sensitivity, whereas the high clean probing accuracy provides more direct evidence that supervised probes can predict the evaluated task variables from the latent states. These findings do not establish that all semantic information is preserved or that spatial entanglement is the sole bottleneck. Nevertheless, they suggest that poor reconstruction alone is insufficient to diagnose missing task-relevant information, motivating interventions that help downstream learners use the information available in these representations.
