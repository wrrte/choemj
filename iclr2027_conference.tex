...
\caption{
Background corruption and supervised decoding.
(a) Representative Frostbite and Seaquest observations across noise strengths $\alpha$.
(b) Mean class accuracy of separately trained probes at each strength.
Overall accuracy and full experimental details are reported in
Appendix~\ref{subsec:appendix_noise_sweep}.
}
