...
We evaluate our method across all 26 games of the Atari 100k benchmark. \todo{네 시드로 각각 학습을 수행하여, 각 학습 마다 20개의 시드에서 평가를 함. 이 100개의 결과를 평균내어 특정 모델의 한 게임에 대한 성능을 구함. 각 Flash 적용-미적용 쌍은 같은 GPU의 같은 가상환경, 같은 시드로 평가. 자세한 방법은 부록에서 설명(부록에서 예시 들어서 자세히 설명. 한 게임에서 GPU를 다르게 쓸 순 있지만 항상 페어는 맞췄다고. 예시를 들고.)}
...
\midrule
Alien         & 227.8 & 7127.7 & 1041.8 & \textcolor{blue}{1091.1} & - & - & - & -  \\
Amidar        & 5.8 & 1719.5 & 175.9 & \textcolor{red}{150.5} & - & - & - & -  \\
...
BattleZone    & 2360.0 & 37187.5 & 10575 & \textcolor{blue}{10608.3} & - & - & - & -  \\
...
Freeway       & 0.0 & 29.6 & - & - & - & - & - & -  \\
Frostbite     & 65.2 & 4334.7 & 1807.5 & \textcolor{blue}{2059.5} & - & - & - & -  \\
...
Krull         & 1598.0 & 2665.5 & 5608 & \textcolor{blue}{5915.2} & - & - & - & -  \\
...
Mean ($\uparrow$) & 0.000 & 1.000 & 0.965  & \textcolor{blue}{1.002} & -  & -  & -  & -  \\
Median ($\uparrow$) & 0.000 & 1.000 & 0.405  & \textcolor{blue}{0.416} & -  & -  & -  & -  \\
IQM ($\uparrow$) & 0.000 & 1.000 & 0.433  & \textcolor{blue}{0.470} & -  & -  & -  & -  \\
Optimality Gap ($\downarrow$) & 1.000 & 0.000 & 0.514  & \textcolor{blue}{0.499} & -  & -  & -  & -  \\
\bottomrule
\end{tabular}
}
\end{table}
...
\todo{그래도 일단 특정 지표와 비례한 성능 증가를 통한 분석 정도는 넣는 게 좋지 않을까? 그리고 분석 좀 수정하기}
